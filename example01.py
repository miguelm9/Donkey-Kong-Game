...
class WarShipz(object):
    def __init__(self):
        ...
        self.projectiles = []
        pyxel.sound(0).set("e3e3c3f1 g1g1c2e2 d2d2d2g2 g2g2rr" "c2c2a1e1 e1e1a1c2 b1b1b1e2 e2e2rr", "p", "6",
                           "vffn fnff vffs vfnn", 25, )
        pyxel.sound(1).set("r a1b1c2 b1b1c2d2 g2g2g2g2 c2c2d2e2" "f2f2f2e2 f2e2d2c2 d2d2d2d2 g2g2r r ", "s", "6",
                           "nnff vfff vvvv vfff svff vfff vvvv svnn", 25, )
        pyxel.sound(2).set("c1g1c1g1 c1g1c1g1 b0g1b0g1 b0g1b0g1" "a0e1a0e1 a0e1a0e1 g0d1g0d1 g0d1g0d1", "t", "7", "n",
                           25, )
        pyxel.sound(3).set("f0c1f0c1 g0d1g0d1 c1g1c1g1 a0e1a0e1" "f0c1f0c1 f0c1f0c1 g0d1g0d1 g0d1g0d1", "t", "7", "n",
                           25, )
    ...
    def update(self):
        if self.in_game:
            ...
            for heart in self.hearts:
                ...
                if (
                        heart.x - 1 or heart.x - 2 or heart.x - 3 or heart.x or heart.x + 1 or heart.x + 2 or heart.x + 3) in [
                    self.warship.x + 8, self.warship.x - 8, self.warship.x - 1, self.warship.x - 2, self.warship.x - 3,
                    self.warship.x - 4, self.warship.x - 5, self.warship.x - 6, self.warship.x - 7, self.warship.x,
                    self.warship.x + 1, self.warship.x + 2, self.warship.x + 3, self.warship.x + 4, self.warship.x + 5,
                    self.warship.x + 6, self.warship.x + 7] and heart.y in [self.warship.y + 1, self.warship.y + 2,
                                                                            self.warship.y, self.warship.y - 1,
                                                                            self.warship.y - 2, self.warship.y - 3,
                                                                            self.warship.y - 4]:
            ...
            for projectile in [_ for _ in self.projectiles if _.affiliation == 'ship']:
                for enemy in self.enemies:
                    if projectile.x in [enemy.x, enemy.x + 1, enemy.x - 1, enemy.x + 2,
                                        enemy.x - 2] and projectile.y in [enemy.y, enemy.y + 1, enemy.y + 2,
                                                                          enemy.y - 1]:
                        self.enemies.remove(enemy)
            ...
            for projectile in [_ for _ in self.projectiles if _.affiliation != 'ship']:
                if projectile.x in [self.warship.x + 8, self.warship.x - 8, self.warship.x - 1, self.warship.x - 2,
                                    self.warship.x - 3, self.warship.x - 4, self.warship.x - 5, self.warship.x - 6,
                                    self.warship.x - 7, self.warship.x, self.warship.x + 1, self.warship.x + 2,
                                    self.warship.x + 3, self.warship.x + 4, self.warship.x + 5, self.warship.x + 6,
                                    self.warship.x + 7] and projectile.y in [self.warship.y + 1, self.warship.y + 2,
                                                                             self.warship.y, self.warship.y - 1,
                                                                             self.warship.y - 2, self.warship.y - 3,
                                                                             self.warship.y - 4]:
                    self.warship.life -= 2
